...
const playerInfo = { background: 'white', borderRadius: '15px', margin: '10px', height: '50px', width: 'auto', maxWidth: '35%', minWidth: '15%', padding: '15px', fontSize: '4vw', borderWidth: '1px', borderColor: '#424949', borderStyle: 'solid' }
