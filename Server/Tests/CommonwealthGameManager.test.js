...
describe('Testing the game manager for the vanilla game', () => {
    ...
    test('Distributes political capital correctly with a party card', () => {
        gameManager.advanceRound();
        const playerOne = new MockedRoomSocket('default', 1);
        const playerTwo = new MockedRoomSocket('default', 2);
        const playerThree = new MockedRoomSocket('default', 3);
        ...
        playerOne.on('finalizePartyCard', {type: 'neutral', value: 'Get Sen'});
        playerTwo.on('finalizePartyCard', {type: 'neutral', value: 'Lose 20'});
        playerThree.on('finalizePartyCard', {type: 'neutral', value: '2x Both'});

        playerOne.on('vote', {yes: 3, no: 0});
        playerTwo.on('vote', {yes: 3, no: 0});
        playerThree.on('vote', {yes: 3, no: 0});
        ...
        expect(gameManager.players['PLAYER ONE'].senators).toEqual(4);
        expect(gameManager.players['PLAYER TWO'].politicalCapital).toEqual(55);
        expect(gameManager.players['PLAYER TWO'].senators).toEqual(3);
        expect(gameManager.players['PLAYER THREE'].politicalCapital).toEqual(120);
        expect(gameManager.players['PLAYER THREE'].senators).toEqual(3);
        ...
        playerOne.on('finalizePartyCard', {type: 'neutral', value: 'Get 20'});
        playerTwo.on('finalizePartyCard', {type: 'neutral', value: '2x Both'});
        playerThree.on('finalizePartyCard', {type: 'neutral', value: 'Lose Sen'});
        ...
        expect(gameManager.players['PLAYER ONE'].politicalCapital).toEqual(70);
        expect(gameManager.players['PLAYER ONE'].senators).toEqual(4);
        expect(gameManager.players['PLAYER TWO'].politicalCapital).toEqual(15);
        expect(gameManager.players['PLAYER TWO'].senators).toEqual(2);
        expect(gameManager.players['PLAYER THREE'].politicalCapital).toEqual(95);
        expect(gameManager.players['PLAYER THREE'].senators).toEqual(2);
